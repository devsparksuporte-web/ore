    ...
    sections: [
      {
        ...
        widgets: [
          {
            id: "vf-cash", dataStatus: "DEMONSTRATIVO", visualization: "kpi", span: { base: 12, md: 6, xl: 3 },
            href: "/e/ativa-mineracao/financeiro/fluxo-de-caixa",
            query: { source: "platform", dataset: "kpi", indicator: "cash", company: "ativa-mineracao", period: { month: "2026-06" } },
          },
          {
            id: "vf-ebitda", dataStatus: "DEMONSTRATIVO", visualization: "kpi", span: { base: 12, md: 6, xl: 3 },
            href: "/e/ativa-mineracao/financeiro/dre", tone: "warning",
            query: { source: "platform", dataset: "kpi", indicator: "ebitda", company: "ativa-mineracao", period: { month: "2026-06" }, compareWith: "budget" },
          },
          {
            id: "vf-costs", dataStatus: "DEMONSTRATIVO", visualization: "kpi", span: { base: 12, md: 6, xl: 3 },
            href: "/e/ativa-mineracao/financeiro/oxr", tone: "danger",
            query: { source: "platform", dataset: "kpi", indicator: "costs", company: "ativa-mineracao", period: { month: "2026-06" }, compareWith: "budget" },
          },
          {
      ...
      },
      {
        ...
        widgets: [
          {
            id: "vf-cashflow", dataStatus: "DEMONSTRATIVO", visualization: "cash-combo", title: "Fluxo de caixa",
            description: "R$ mi · semanal · realizado + projetado", span: { base: 12, xl: 8 },
            query: { source: "platform", dataset: "cash_flow", company: "ativa-mineracao", period: { view: "ltm" } },
          },
          {
            id: "vf-banks", dataStatus: "DEMONSTRATIVO", visualization: "status", title: "Posição por conta", span: { base: 12, xl: 4 },
            query: { source: "platform", dataset: "bank_position", company: "ativa-mineracao" },
          },
        ],
      },
      {
        ...
        widgets: [
          {
            id: "vf-bridge", dataStatus: "DEMONSTRATIVO", visualization: "waterfall", title: "Ponte do EBITDA — junho",
          ...
          {
            id: "vf-forecast", dataStatus: "DEMONSTRATIVO", visualization: "line-forecast", title: "EBITDA — trajetória do ano",
          ...
          {
            id: "vf-capex", dataStatus: "DEMONSTRATIVO", visualization: "progress", title: "CAPEX — execução do ano", span: { base: 12, xl: 3 },
      ...
      },
      {
        ...
        widgets: [
          {
            id: "vf-integrations", visualization: "status", title: "Fontes de dados", span: { base: 12, md: 6 },
